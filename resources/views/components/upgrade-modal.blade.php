<x-filament::modal id="upgrade-modal" :sticky-header="true">
    <h3 class="text-2xl font-semibold text-center">{{$plan->name}}</h3>
    <div class="mt-2 text-center">
        <span class="text-4xl font-bold">{{$plan->currency}}{{$billingPrice}}</span>
    ...
    <div class="columns-1 fi-fo-toggle-buttons gap-3 flex flex-wrap justify-center">
        <div>
            <input id="monthly" name="billingCycle" type="radio" value="monthly" wire:loading.attr="disabled"
                   wire:model.live="billingCycle" class="peer pointer-events-none absolute opacity-0" checked>
        ...
        <div>
            <input id="yearly" name="billingCycle" type="radio" value="monthly" wire:loading.attr="disabled"
